...
void mt_gemma_test ( const std::string & phenotype_path, const std::string & genotype_path, const std::string & kinship_file, const double & maf){
    ...
    double man_l = maf * number_of_individuals;
    double man_u = (double)number_of_individuals - man_l;

    AnalyzePlink( eigen_r, UtW, UtY, method, k_i, genotype, Y, man_l, man_u);
}

void mt_gemma_test_MultiAllic ( const std::string & phenotype_path, const std::string & genotype_path, const std::string & kinship_file, const double & maf){
    ...
    AnalyzePlink_MultiAllic( eigen_r, UtW, UtY, method, k_i, genotype, Y, man_l, man_u);
}
